...
if (isset($_POST["updatepost"])) {
    ...
    if ($tmp_name != " ") {
        ...
        $query = "UPDATE posts SET title='$title', body='$body', imagename='$image' WHERE id='$id'";
    }else {
    ...
    if ($result) {
        ...
        header("Refresh:0; url=managepost.php");
...
<div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <!-- ============================================================== -->
            <?php
            // prefil the input fields with data from the database
            if (isset($_GET["id"])) {
                $id = $_GET['id'];
                ...
                <div class="col-md-12">
                    <div class="white-box analytics-info">
                        <h3 class="box-title">Edit Post</h3>
                            ...
                            <form action="editpost.php" method="POST" enctype="multipart/form-data" style="width: 50%;">    
                                <input type="hidden" name="id" value="<?php echo $id ?>">
                                <label>Title:</label><br>
                                <input class="text" type="text" name="title" value="<?php echo $title ?>" placeholder="Title" class="form-control" style="margin-bottom: 5px !important;"><br>
                                <label>Body:</label>
                                <div class="mb-3">
                                ...
                                <input type="submit" value="Update Post" name="updatepost" class="btn btn-info">
                                </div>
				            </form>
                    </div>
                </div>
